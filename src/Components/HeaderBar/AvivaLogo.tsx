const AvivaLogo = ({ width = 130, height = 24 }) => {
  return (
    <svg width={width} height={height} viewBox="0 0 130 24">
      <defs>
        <path id="a" d="M2.884.092L.964 19.921a78.37 78.37 0 013.813-.325L2.885.092h-.001z" />
        <path
          id="c"
        ...
        />
        <path id="g" d="M.002.223V.83c.418.075 1.913.511 1.913 1.575v17.04h5.061V.222H.002z" />
        <path
          id="i"
      ...
      <g fill="none" fillRule="evenodd">
        <g transform="translate(14.182)">
          ...
          <path fill="#FFD400" d="M-4.946 25.83h15.633V-5.817H-4.946z" mask="url(#b)" />
        </g>
        <g transform="translate(16.545)">
          <mask id="d" fill="#fff">
            <use xlinkHref="#c" />
          </mask>
          <path fill="#66B24C" d="M-5.38 25.482h18.33V-5.796H-5.38z" mask="url(#d)" />
        </g>
        <mask id="f" fill="#fff">
          <use xlinkHref="#e" />
        </mask>
        <path fill="#004FB6" d="M-5.91 29.545h28.885V-5.819H-5.91z" mask="url(#f)" />
        <g transform="translate(75.636)">
          <mask id="h" fill="#fff">
            <use xlinkHref="#g" />
          </mask>
          <path fill="#004FB6" d="M-5.907 25.354h18.792v-31.04H-5.907z" mask="url(#h)" />
        </g>
        <g transform="translate(29.545)">
          <mask id="j" fill="#fff">
            <use xlinkHref="#i" />
          </mask>
          <path fill="#004FB6" d="M-5.763 25.354H28.08v-31.04H-5.763z" mask="url(#j)" />
        </g>
        <g transform="translate(106.364)">
          <mask id="l" fill="#fff">
            <use xlinkHref="#k" />
          </mask>
          <path fill="#004FB6" d="M-4.974 25.354h33.843v-31.04H-4.974z" mask="url(#l)" />
        </g>
        <g transform="translate(85.09)">
          <mask id="n" fill="#fff">
            <use xlinkHref="#m" />
          </mask>
          <path fill="#004FB6" d="M-5.373 25.354H28.8v-31.04H-5.373z" mask="url(#n)" />
        </g>
        <g transform="translate(49.636)">
          <mask id="p" fill="#fff">
            <use xlinkHref="#o" />
          </mask>
          <path fill="#004FB6" d="M-5.003 25.354h34.174v-31.04H-5.003z" mask="url(#p)" />
        </g>
      </g>
    </svg>
  );
